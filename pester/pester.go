...
func (c *Client) pester(ctx context.Context, p params) (*http.Response, error) {
...
func (c *Client) Post(url string, bodyType string, body io.Reader) (*http.Response, error) {
	return c.PostContext(context.TODO(), url, bodyType, body)
}
...
func Do(req *http.Request) (*http.Response, error) { return New().Do(req) }

// Get provides the same functionality as http.Client.Get and creates its own constructor
func Get(url string) (*http.Response, error) { return New().Get(url) }

// Head provides the same functionality as http.Client.Head and creates its own constructor
func Head(url string) (*http.Response, error) { return New().Head(url) }
